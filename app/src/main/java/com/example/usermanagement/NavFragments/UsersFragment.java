...
public class UsersFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //retrofit
        Call<FetchUserResponse> fetchUserResponseCall = RetrofitClient.getInstance().getApi().fetchAllUsers();

        fetchUserResponseCall.enqueue(new Callback<FetchUserResponse>() {
            @Override
